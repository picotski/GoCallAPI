...
func GetCalls(db *sql.DB, page, count int) ([]call.Call, error) {
	rows, err := db.Query(
...
// Get one call
func GetCall(db *sql.DB, id int) (call.Call, error) {
	c := call.Call{ID: id}
...
// Delete one call
func DeleteCall(db *sql.DB, id int) (call.Call, error) {
	_, err := db.Exec(
...
// Create one call
func CreateCall(db *sql.DB, c call.Call) (call.Call, error) {
	call := call.Call{}
...
// Stop call
func StopCall(db *sql.DB, id int) (call.Call, error) {
	_, err := db.Exec(
